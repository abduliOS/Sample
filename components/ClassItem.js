    ...
    render() {
        ...
        return (
            <View style={{ padding: 5, backgroundColor: bgColor, width: 80, height: 45, elevation: 5, borderRadius: 5, justifyContent: 'center', marginRight: 10 }} >
                <Text style={{ textAlign: 'center', color: txtColor, marginTop: 3, fontSize: screenWidth / 30 }} >{data.className}</Text>
                <Text style={{ textAlign: 'center', color: txtColor, fontSize: screenWidth / 30 }} >{data.fareAmount}</Text>
            </View>
        );
    }
