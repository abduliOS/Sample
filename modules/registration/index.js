            ...
            <LinearGradient colors={AppColors.BACKGROUND_GRADIENT} style={styles.container}>
                ...
                <LinearGradient colors={AppColors.DIALOG_GRADIENT} style={styles.innerContainer}>
                    ...
                    <View style={{ flexDirection: 'row', padding: 5 }} >
                        ...
                        <Text style={{ flex: 0.8, textAlign: 'center', alignSelf: 'center', fontSize: 18, color: '#eee9e9' }} >REGISTRATION</Text>
                    ...
                    <View style={styles.container} >
                        ...
                        <View style={{ padding: 40, justifyContent: 'center' }} >
                            ...
                            <View>
                                <TextInput placeholder={'Email'} placeholderTextColor={'#b4b4ac'} style={{ backgroundColor: 'transparent', top: 5, fontSize: 18 }} />
                                <View style={{ height: 0.5, backgroundColor: '#b4b4ac' }} />
                            </View>

                            <View>
                                <TextInput placeholder={'+91 mobile number'} placeholderTextColor={'#b4b4ac'} style={{ backgroundColor: 'transparent', top: 5, fontSize: 18 }} />
                                <View style={{ height: 0.5, backgroundColor: '#b4b4ac' }} />
                            </View>
                            ...
                            <TouchableOpacity style={styles.loginBtnContainer} >
                                <Text style={styles.rateMovieText} >REGISTER</Text>
                            </TouchableOpacity>
